      ...
      <main className="flex-grow flex flex-col items-center justify-center p-8 text-center">
        ...
        <div className="max-w-xl text-left bg-gray-50 p-4 rounded shadow">
          ...
          <ol className="list-decimal list-inside space-y-2">
            <li>
              <strong>Klik op &quot;Bestelling plaatsen&quot;</strong> en upload een foto van wat je wilt laten zandstralen. Geef de kenmerken, afmetingen, gewicht en een korte omschrijving op. Je ontvangt direct een indicatie van de prijs voor het stralen én de verzendkosten.
            </li>
            <li>
